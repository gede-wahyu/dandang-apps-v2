        ...
        <div class="d-sidebar-content filter-menu">
            ...
            <div class="body">
                ...
                <div class="filter-section">
                    <!-- <label for="filter-nofak">No Faktur</label> -->
                    <InputText
                ...
                <div class="filter-section">
                    <!-- <label for="filter-cust">Pelanggan</label> -->
                    <InputText
                ...
                <div class="filter-section">
                    <!-- <label for="filter-ps">Status Transaksi</label> -->
                    <Dropdown
                        v-model="tsfq"
                        :options="tsopt"
                        optionLabel="label"
                ...
                <div class="filter-section">
                    <!-- <label for="filter-amount">Nilai Transaksi</label> -->
                    <InputNumber
                ...
                <div class="filter-section">
                    <!-- <label for="filter-sales">Sales</label> -->
                    <InputText
                ...
                <div class="filter-section">
                    <!-- <label for="filter-depo">Depo</label> -->
                    <InputText
                ...
                <div class="filter-section">
                    <!-- <label for="filter-nofak">Status Pembayaran</label> -->
                    <Dropdown
                        v-model="psfq"
                        :options="psopt"
                        optionLabel="label"
...
const transactions = computed(() => {
    ...
    data = transactionStore.filterTransaction(filters.value, data);
